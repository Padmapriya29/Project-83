...
export default class ExchangeScreen extends React.Component {
  ...
  addRequest = (itemName, reasonForRequest) => {
    ...
    return Alert.alert("Exchange Request Posted Successfully");
  };
      ...
      <View style={{ flex: 1 }}>
        ...
        <KeyboardAvoidingView style={styles.keyBoardStyle} behavior={"padding"}>
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              this.addRequest(this.state.itemName, this.state.reasonForRequest);
            }}
          >
            <Text>Request</Text>
          </TouchableOpacity>
